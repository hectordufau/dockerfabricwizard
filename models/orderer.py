...
class Orderer(BaseModel):
    ...
    ORDERER_GENERAL_TLS_CERTIFICATE: str = (
        "/var/hyperledger/orderer/tls/signcerts/cert.crt"
    )
    # ORDERER_GENERAL_TLS_PRIVATEKEY: str = "/var/hyperledger/orderer/tls/server.key"
    ORDERER_GENERAL_TLS_PRIVATEKEY: str = (
        "/var/hyperledger/orderer/tls/keystore/key.pem"
    )
    # ORDERER_GENERAL_TLS_ROOTCAS: str = "[/var/hyperledger/orderer/tls/ca-root.crt]"
    ORDERER_GENERAL_TLS_ROOTCAS: str = (
        "[/var/hyperledger/orderer/tls/tlscacerts/tls-cert.pem]"
    )
    ...
    ORDERER_ADMIN_TLS_CERTIFICATE: str = (
        "/var/hyperledger/orderer/tls/signcerts/cert.crt"
    )
    ORDERER_ADMIN_TLS_CLIENTROOTCAS: str = (
        "[/var/hyperledger/orderer/tls/tlscacerts/tls-cert.pem]"
    )
    ORDERER_ADMIN_TLS_PRIVATEKEY: str = "/var/hyperledger/orderer/tls/keystore/key.pem"
    ORDERER_ADMIN_TLS_ROOTCAS: str = (
        "[/var/hyperledger/orderer/tls/tlscacerts/tls-cert.pem]"
    )
    ...
    # )
    # ORDERER_GENERAL_CLUSTER_ROOTCAS: str = "[/var/hyperledger/orderer/tls/ca-root.crt]"
